export const fi = {
  message: {
    ...
    supervisorWelcome:'Tervetuloa palveluntarjoajapaneeliin',
    supervisorPassword:'Salasana',
    supervisorLogin:'Kirjaudu sisään',
    supervisorCreate:'Lisää uusi hallinnoija',
    supervisorEmail:'Sähköpostiosoite',
    supervisorMore:'Lisää',
    removeAdminButton:'Poista oikeudet',
    deleteUserButton: 'Poista käyttäjä',
    supervisorSearchButton: 'Etsi',
    supervisorSearchPlaceHolder: 'Nimi tai sähköpostiosoite',
    supervisorSearchUser: 'Etsi käyttäjää',
    supervisorDeleteByEmail: 'Poista tietoja sähköpostiosoitteella',
    supervisorDeleteByEmailPlaceHolder: 'Sähköpostiosoite',
    supervisorDeleteByEmailButton: 'Poista',
