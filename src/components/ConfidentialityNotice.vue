<template>
  <div class="confidentialityWrapper">
    <h2 class="heading">{{ $t('message.confidentialityHeading') }}</h2>
    ...
    <b-button @click="$emit('nextPage')" class="noticeButton">{{ $t('message.confidentialityAccept') }}</b-button>
  </div>
</template>
<script>
